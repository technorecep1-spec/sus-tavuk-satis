...
app.get('/product/:id', async (req, res) => {
    try {
        ...
        res.render('product-detail', { urun: urun, reviews: reviews });
    } catch (err) {
...
app.get('/my-orders', async (req, res) => {
    ...
    try {
        ...
        res.render('my-orders', { siparisler: siparisler });
    } catch (err) {
...
app.get('/my-messages', async (req, res) => {
    ...
    try {
        ...
        res.render('my-messages', { conversations: conversations });
    } catch (err) {
...
app.get('/message/:id', async (req, res) => {
    ...
    try {
        ...
        res.render('conversation-detail', { conversation: conversation });
    } catch (err) {
...
app.get('/cart', (req, res) => {
    ...
    res.render('cart', { cart: processedCart, cartTotal: cartTotal });
});
...
app.get('/admin/edit-product/:id', async (req, res) => {
    ...
    try {
        ...
        res.render('edit-product', { urun: urun });
    } catch (err) {
...
app.get('/admin/order/:id', async (req, res) => {
    ...
    try {
        ...
        res.render('order-detail', { siparis: siparis });
    } catch (err) {
...
app.get('/admin/user/:id', async (req, res) => {
    ...
    try {
        ...
        res.render('user-detail', { viewedUser: user, orders: orders });
